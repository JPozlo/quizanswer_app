            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('questions.store') }} " method="POST">
                        ...
                        <div class="form-group">
                            <label for="question-body">Question Body (Explain your Answer) </label>
                            <textarea name="title" id="question-body" rows="10" class="form-control {{ $errors->has('body') ? 'is-invalid'  : '' }} "></textarea>
